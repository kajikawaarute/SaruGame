...
void PhysicsWorld::AddCollisionObject(btCollisionObject & collObj)
{
	dynamicWorld->addCollisionObject(&collObj);
}

void PhysicsWorld::RemoveCollisionObject(btCollisionObject & collObj)
{
	dynamicWorld->removeCollisionObject(&collObj);
}
